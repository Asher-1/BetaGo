...
//    std::vector<double> translate_euler1 = {5.54,-0.02,0.5, 0.0,-0.67,0.0};
    Eigen::Vector3d euler0 = {0.0,-0.67,0.0};
    Eigen::Matrix3d R0 =  td::EulerToRotation(euler0);
    Eigen::Vector3d euler1 = {3.14,-1.5708,3.14};
    Eigen::Matrix3d R1 =  td::EulerToRotation(euler1);
    Eigen::Vector3d euler2 = {3.14,-1.16,3.14};
    Eigen::Matrix3d R2 =  td::EulerToRotation(euler2);
    Eigen::Matrix3d R01 = R0.transpose() * R1;
    Eigen::Matrix3d R02 = R0.transpose() * R2;
    Eigen::Vector3d euler01 = td::RotationToEulerAngle(R01);
    Eigen::Vector3d euler02 = td::RotationToEulerAngle(R02);
    std::cout<<euler01<<std::endl;
    std::cout<<euler02<<std::endl;
//    euler(0) += 2 * M_PI;
//    Eigen::Matrix3d R_;
